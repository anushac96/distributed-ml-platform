...
class MasterServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RegisterWorker = channel.unary_unary(
                '/distributedml.MasterService/RegisterWorker',
        ...
        self.SendHeartbeat = channel.unary_unary(
                '/distributedml.MasterService/SendHeartbeat',
        ...
        self.RequestJob = channel.unary_unary(
                '/distributedml.MasterService/RequestJob',
                request_serializer=master__pb2.JobRequest.SerializeToString,
                response_deserializer=master__pb2.JobResponse.FromString,
                _registered_method=True)
        self.CompleteJob = channel.unary_unary(
                '/distributedml.MasterService/CompleteJob',
                request_serializer=master__pb2.JobCompleteRequest.SerializeToString,
                response_deserializer=master__pb2.JobCompleteResponse.FromString,
                _registered_method=True)
...
def add_MasterServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RequestJob': grpc.unary_unary_rpc_method_handler(
                    servicer.RequestJob,
                    request_deserializer=master__pb2.JobRequest.FromString,
                    response_serializer=master__pb2.JobResponse.SerializeToString,
            ),
            'CompleteJob': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=master__pb2.JobCompleteResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'distributedml.MasterService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('distributedml.MasterService', rpc_method_handlers)
...
class MasterService(object):
    ...
    def RequestJob(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/distributedml.MasterService/RequestJob',
            master__pb2.JobRequest.SerializeToString,
            master__pb2.JobResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def CompleteJob(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            master__pb2.JobCompleteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
